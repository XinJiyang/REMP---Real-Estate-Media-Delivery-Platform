...
import { PhotographyCompanyRegisterDto } from '../../interface/user';

const PhotographyCompanySignupPage: React.FC = () => {
  ...
  const { createPhotographyCompany, loading, error } = useUser();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const registerDto: PhotographyCompanyRegisterDto = {
      ...
      await createPhotographyCompany(registerDto);
      ...
      <div className="flex justify-center pt-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Signup Photography Company</h2>
...
export default PhotographyCompanySignupPage;